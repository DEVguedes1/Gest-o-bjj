      ...
      <div className="home-wrapper">
        {/* 1. HERO - FOCO TOTAL EM CONVERSÃO */}
          <section className="hero">
            ...
            <div className="container hero-content">
              <span className="subtitle">Escola de Jiu-Jitsu Bruno Caetano</span>
              ...
              <div className="cta-group">
                ...
                <Link to="/login" className="btn-primary btn-outline">Já sou aluno / Entrar</Link>
              </div>
            </div>
          </section>
        ...
        <footer className="footer-bg">
          <div className="container footer-content">
            <p>&copy; 2026 Bruno Caetano BJJ. Todos os direitos reservados.</p>
            <Link to="/login" className="footer-admin-link">Área do Coordenador</Link>
          </div>
        </footer>
      </div>
    );
